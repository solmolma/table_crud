<h2><?php echo \core\Idioma::text("Modificar Libro", "plantilla_libros"); ?></h2>
<form id='form_modificar' method='post' action='<?php echo \core\URL::generar_con_idioma("libros/form_modificar_validar/{$datos['values']['id']}");?>'>
